...
public class ReviewController {
    ...
    @GetMapping(value = REVIEWS_CONTROLLER_URL + ADMIN_CONTROLLER_URL)
    ...
    @PostMapping(value = REVIEWS_CONTROLLER_URL + ADMIN_CONTROLLER_URL + DEL_CONTROLLER_URL + "/{uuid}/{sourcePageNumber}")
    public String delReviews(@PathVariable String uuid, @PathVariable String sourcePageNumber) {
        reviewService.removeByUuid(uuid);
        return "redirect:" + REVIEWS_CONTROLLER_URL + ADMIN_CONTROLLER_URL +"?pageNumber=" + sourcePageNumber;
    }

    @PostMapping(value = REVIEWS_CONTROLLER_URL + ADMIN_CONTROLLER_URL + CHANGE_VISIBILITY_CONTROLLER_URL + "/{sourcePageNumber}")
